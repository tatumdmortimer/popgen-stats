...
def rep_ll_bottlegrowth(data, ns, bottlegrowth_params, bottlegrowth_upper_bound,
    ...
    avg_nuB_bottlegrowth = numpy.median(bottlegrowth_nuB_vals)
    avg_nuF_bottlegrowth = numpy.median(bottlegrowth_nuF_vals)
    avg_tau_bottlegrowth = numpy.median(bottlegrowth_tau_vals)
...
avg_ll_bottlegrowth, avg_nuB_bottlegrowth, avg_nuF_bottlegrowth, avg_tau_bottlegrowth, max_ll_bottlegrowth, max_nuB_bottlegrowth, max_nuF_bottlegrowth, max_tau_bottlegrowth = rep_ll_bottlegrowth(data, ns, bottlegrowth_params, bottlegrowth_upper_bound, bottlegrowth_lower_bound, bottlegrowth_func_ex, pts_l)
